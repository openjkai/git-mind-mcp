...
**MCP server for Git intelligence** — status, diff, blame, branches, stage, commit, push, pull, checkout, branching. Works with any MCP-compatible client (Cursor, Claude Desktop, [LibreChat](https://librechat.ai), etc.).
